...
class PresencesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create presence" do
    assert_difference('Presence.count') do
      post presences_url, params: { presence: { datecours: @presence.datecours, etat: @presence.etat } }
    end
  ...
  test "should update presence" do
    patch presence_url(@presence), params: { presence: { datecours: @presence.datecours, etat: @presence.etat } }
