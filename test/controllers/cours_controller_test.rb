...
class CoursControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cour" do
    assert_difference('Cour.count') do
      post cours_url, params: { cour: { adresse: @cour.adresse, cp: @cour.cp, dateh: @cour.dateh, duree: @cour.duree, nomvil: @cour.nomvil, telephon: @cour.telephon, typcours: @cour.typcours } }
    end
  ...
  test "should update cour" do
    patch cour_url(@cour), params: { cour: { adresse: @cour.adresse, cp: @cour.cp, dateh: @cour.dateh, duree: @cour.duree, nomvil: @cour.nomvil, telephon: @cour.telephon, typcours: @cour.typcours } }
